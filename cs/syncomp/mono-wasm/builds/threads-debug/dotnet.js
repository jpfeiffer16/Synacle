...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 729456,
    DYNAMIC_BASE = 5972336,
    DYNAMICTOP_PTR = 728528;
...
var ASM_CONSTS = {
  614072: function() {return STACK_MAX;},  
 614094: function() {return TOTAL_STACK;},  
 666700: function($0, $1) {MONO.string_decoder.decode($0, $0 + $1, true);},  
 666979: function($0, $1, $2) {var str = MONO.string_decoder.decode ($0, $0 + $1); try { var res = eval (str); if (res === null || res == undefined) return 0; res = res.toString (); setValue ($2, 0, "i32"); } catch (e) { res = e.toString (); setValue ($2, 1, "i32"); if (res === null || res === undefined) res = "unknown exception"; } var buff = Module._malloc((res.length + 1) * 2); stringToUTF16 (res, buff, (res.length + 1) * 2); return buff;},  
 667398: function() {var err = new Error(); console.log ("Stacktrace: \n"); console.log (err.stack);},  
 676389: function() {throw 'Canceled!'}
};
...
// {{PRE_LIBRARY}}
  ...
  var __main_thread_futex_wait_address=729440;function _emscripten_futex_wake(addr, count) {
  ...
  function __cleanup_thread(pthread_ptr) {
      ...
      if (pthread) {
        ...
        PThread.mainThreadBlock = 728688;
  ...
  if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(2, 1, call, socketvararg);
  try {
   // socketcall
  ...
  if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(5, 1, addr, len, flags);
  try {
   // msync
  ...
  if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(7, 1, fds, nfds, timeout);
  try {
   // poll
      var nonzero = 0;
  ...
  if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(9, 1, addr, len, prot, flags, fd, off);
  try {
   // mmap2
  ...
  if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(15, 1, fd, cmd, varargs);
  ...
  if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(16, 1, path, size, buf);
  try {
   // statfs64
      path = SYSCALLS.getStr(path);
      assert(size === 64);
  ...
  if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(18, 1, dirfd, path, times, flags);
  try {
   // utimensat
      path = SYSCALLS.getStr(path);
      assert(flags === 0);
  ...
  if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(19, 1, path, amode);
  try {
   // access
      path = SYSCALLS.getStr(path);
  ...
  if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(25, 1, path, flags, varargs);
  SYSCALLS.varargs = varargs;
  try {
   // open
  ...
  if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(27, 1, oldfd, suggestFD);
  try {
   // dup2
  ...
  if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(28, 1, who, usage);
  try {
   // getrusage
      _memset(usage, 0, 136);
  ...
  if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(29, 1, target, linkpath);
  try {
   // symlink
  ...
  if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(30, 1, path, buf, bufsize);
  try {
   // readlink
      path = SYSCALLS.getStr(path);
  ...
  if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(31, 1, addr, len);
  try {
   // munmap
  ...
  if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(32, 1, fd, mode);
  try {
   // fchmod
      FS.fchmod(fd, mode);
      return 0;
  ...
  var ___tm_timezone=(stringToUTF8("GMT", 728592, 4), 728592);function _gmtime_r(time, tmPtr) {
...
var proxiedFunctionTable = [null,___syscall10,___syscall102,___syscall12,___syscall142,___syscall144,___syscall15,___syscall168,___syscall183,___syscall192,___syscall194,___syscall195,___syscall196,___syscall197,___syscall220,___syscall221,___syscall268,___syscall3,___syscall320,___syscall33,___syscall38,___syscall39,___syscall40,___syscall41,___syscall42,___syscall5,___syscall54,___syscall63,___syscall77,___syscall83,___syscall85,___syscall91,___syscall94,_atexit,_emscripten_set_canvas_element_size_main_thread,_fd_close,_fd_fdstat_get,_fd_read,_fd_seek,_fd_sync,_fd_write,_getaddrinfo,_tzset,_sysconf,_utime,_utimes];
