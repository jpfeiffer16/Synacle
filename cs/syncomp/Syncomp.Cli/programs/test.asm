...
jmp >before_each_end
:before_each
jmp >var_before_each_func_testlib_15_end
:var_before_each_func_testlib_15
:var_before_each_func_testlib_15_end
wmem >var_before_each_func_testlib_15 reg0
rmem reg0 >var_before_each_func_testlib_15
wmem >var_current_before_each_testlib_6 reg0
ret
:before_each_end
...
jmp >test_end
:test
jmp >var_name_testlib_25_end
:var_name_testlib_25
:var_name_testlib_25_end
jmp >var_test_func_testlib_25_end
:var_test_func_testlib_25
:var_test_func_testlib_25_end
wmem >var_name_testlib_25 reg0
wmem >var_test_func_testlib_25 reg1
rmem reg0 >var_name_testlib_25
wmem >var_current_test_testlib_5 reg0
rmem reg7 >var_test_func_testlib_25
call reg7
ret
:test_end
set reg0 >test
jmp >assert_end
:assert
jmp >var_fact_testlib_31_end
:var_fact_testlib_31
:var_fact_testlib_31_end
wmem >var_fact_testlib_31 reg0
rmem reg0 >var_current_test_testlib_5
jmp >var__testlib_32_end
:var__testlib_32
&:
32
0
:var__testlib_32_end
wmem >var__testlib_32 32
set reg1 >var__testlib_32
call >str_cat
call >print
rmem reg0 >var_fact_testlib_31
set reg1 1
eq reg0 reg0 reg1
call >not
jf reg0 >end__testlib_33
jmp >var__testlib_35_end
:var__testlib_35
&A
&I
&L
...
0
:var__testlib_35_end
wmem >var__testlib_35 &F
set reg0 >var__testlib_35
call >println
